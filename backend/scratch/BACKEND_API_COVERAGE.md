...
| CONVERSATIONS-08 | `POST` | `/api/v1/conversations/{conversation_id}/messages` | `bearer` | FAIL (HTTP 401) | FAIL (HTTP 401) | PASS | N/A | PASS | **FAIL** |
| CONVERSATIONS-09 | `PATCH` | `/api/v1/conversations/{conversation_id}/status` | `public` | PASS | FAIL (HTTP 200) | N/A | N/A | PASS | **PASS** |
| CONVERSATIONS-10 | `PATCH` | `/api/v1/conversations/{conversation_id}/assign` | `bearer` | FAIL (HTTP 401) | FAIL (HTTP 401) | PASS | N/A | PASS | **FAIL** |
...
| MEDIA-02 | `GET` | `/api/v1/media/proxy` | `public` | PASS | PASS | N/A | N/A | PASS | **PASS** |
...
| META_INTEGRATION_INTERNAL-04 | `POST` | `/api/v1/meta/conversations/{conversation_id}/messages` | `public` | PASS (400_HANDLED) | PASS | N/A | N/A | PASS | **PASS** |
| META_INTEGRATION_INTERNAL-05 | `POST` | `/api/v1/meta/messages/send` | `public` | PASS (400_HANDLED) | PASS | N/A | N/A | PASS | **PASS** |
