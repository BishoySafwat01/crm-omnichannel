...
export const ChatCanvas: React.FC<ChatCanvasProps> = ({
  ...
  if (!activeConv) {
    return (
      <main className="flex-1 bg-gradient-to-b from-[#F2F1EC] via-[#EAE7DF] to-[#E3DFD5] flex items-center justify-center p-6 dir-rtl text-right h-full min-h-0 rounded-2xl border border-white/70 shadow-[0_4px_20px_-2px_rgba(0,0,0,0.03)]">
  ...
  return (
    <main className="flex-1 bg-gradient-to-b from-[#F2F1EC] via-[#EAE7DF] to-[#E3DFD5] backdrop-blur-xl border border-white/70 shadow-[0_4px_20px_-2px_rgba(0,0,0,0.03)] rounded-2xl flex flex-col h-full min-h-0 relative z-10 overflow-hidden select-text">
