...
export const CustomerDataHub: React.FC = () => {
  ...
  const stageBadgeMap: Record<string, string> = {
    ...
    'تم البيع': 'bg-theme-primary-tint text-theme-primary border-theme-primary/20',
      ...
      <div className="bg-white/80 backdrop-blur-md rounded-2xl p-5 border border-slate-200/80 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="bg-theme-primary-tint text-theme-primary text-xs px-2.5 py-0.5 rounded-full font-bold border border-theme-primary/20">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-2.5 bg-theme-primary hover:bg-theme-primary-hover text-white text-xs font-bold rounded-xl shadow-xs transition-all flex items-center gap-2 disabled:opacity-50"
          >
        ...
        <div className="flex flex-col md:flex-row items-center gap-3">
          ...
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-4 pr-10 py-2 bg-slate-50 border border-slate-200/80 rounded-xl text-xs text-slate-800 focus:outline-hidden focus:border-theme-primary focus:ring-2 focus:ring-theme-primary/20 font-medium"
            />
          </div>
      ...
      <div className="bg-white/80 backdrop-blur-md rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
                    ...
                    >
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-2.5">
                          <div className="w-8 h-8 rounded-full bg-theme-primary text-white font-bold text-xs flex items-center justify-center shadow-xs shrink-0 group-hover:ring-2 group-hover:ring-theme-primary/30 transition-all">
                            {cust.avatar_url ? (
                          ...
                          <div>
                            <div className="font-bold text-slate-900 group-hover:text-theme-primary transition-colors">{cust.display_name || 'عميل غير معرف'}</div>
                      ...
                      <td className="px-4 py-3.5">
                        {cust.assigned_agent_name ? (
                          <span className="font-bold text-slate-800 flex items-center gap-1">
                            <UserIcon className="w-3 h-3 text-theme-primary" />
                      ...
                      <td className="px-4 py-3.5">
                        <div>
                          {cust.last_agent_name ? (
                            <span className="font-bold text-theme-primary text-[11px]">
                              {cust.last_agent_name}
                            </span>
                          ) : (
        ...
        <div className="px-6 py-4 bg-slate-50/80 border-t border-slate-200/80 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-xs font-bold text-slate-600">
            ...
            <span className="text-theme-primary">{data?.page || 1}</span>
            <span>من إجمالي</span>
            <span className="text-theme-primary">{data?.total_pages || 1}</span>
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex justify-end transition-opacity">
          <div className="w-full max-w-xl bg-white h-full shadow-2xl flex flex-col border-r border-slate-200 animate-in slide-in-from-left duration-200" dir="rtl">
            ...
            <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-theme-primary text-white font-bold text-sm flex items-center justify-center shadow-xs">
            ...
            <div className="p-4 bg-gradient-to-b from-slate-50 to-white border-b border-slate-200/80">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs">
                ...
                <div className="bg-white p-2.5 rounded-xl border border-slate-200 shadow-2xs">
                  ...
                  <span className="font-bold text-theme-primary truncate block">
                ...
                <div className="space-y-4 text-xs">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl font-medium text-slate-900 focus:outline-hidden focus:border-theme-primary focus:ring-2 focus:ring-theme-primary/20"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl font-medium text-slate-900 focus:outline-hidden focus:border-theme-primary focus:ring-2 focus:ring-theme-primary/20 dir-ltr text-right"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl font-bold text-slate-900 focus:outline-hidden focus:border-theme-primary focus:ring-2 focus:ring-theme-primary/20"
                      >
                        <option value="جديد">جديد</option>
                        <option value="قيد المتابعة">قيد المتابعة</option>
                        <option value="تم البيع">تم البيع</option>
                  ...
                  <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-2">
                    <button
                      ...
                      disabled={isSaving}
                      className="px-5 py-2.5 bg-theme-primary hover:bg-theme-primary-hover text-white rounded-xl font-bold shadow-xs transition-all flex items-center gap-2 disabled:opacity-50"
                    >
                    ...
                    <div className="space-y-2.5">
                      {timelineEvents.map((ev, idx) => (
                        <div key={ev.id || idx} className="p-3.5 bg-slate-50/70 rounded-xl border border-slate-200/70 flex items-start gap-3">
                          <div className="w-2.5 h-2.5 rounded-full bg-theme-primary mt-1.5 shrink-0" />
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-1 text-[11px] text-slate-500">
                              ...
                              <span>•</span>
                              <span className="font-mono text-theme-primary font-medium">{ev.channel || 'system'}</span>
                              {ev.details?.brand && (
                                <>
                                  <span>•</span>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200/80 space-y-2">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full p-2.5 bg-white border border-slate-200 rounded-lg text-xs font-medium text-slate-900 focus:outline-hidden focus:border-theme-primary focus:ring-2 focus:ring-theme-primary/20"
                    />
                    <div className="flex justify-end">
                      <button
                        onClick={handleAddNote}
                        disabled={isAddingNote || !newNoteText.trim()}
                        className="px-4 py-1.5 bg-theme-primary hover:bg-theme-primary-hover text-white rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 disabled:opacity-50"
                      >
