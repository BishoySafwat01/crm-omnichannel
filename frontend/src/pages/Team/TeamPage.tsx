...
export const TeamGovernance: React.FC = () => {
  ...
  const getRoleBadge = (role: string) => {
    switch (role.toLowerCase()) {
      ...
      default:
        return (
          <span className="px-2.5 py-1 rounded-full bg-theme-primary-tint text-theme-primary text-[11px] font-bold border border-theme-primary/20 flex items-center gap-1 w-max">
  ...
  const getActionBadge = (action: string) => {
    switch (action) {
      ...
      case 'user.activated':
        return <span className="px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 text-[11px] font-bold border border-emerald-200">تفعيل حساب</span>;
      ...
      case 'customer.note_created':
        return <span className="px-2 py-0.5 rounded-full bg-theme-primary-tint text-theme-primary text-[11px] font-bold border border-theme-primary/20">إضافة ملاحظة</span>;
        ...
        <div className="flex items-center gap-3">
          ...
          {activeTab === 'roster' && (
            <button
              ...
              className="px-4 py-2 rounded-xl bg-theme-primary hover:bg-theme-primary-hover text-white text-xs font-bold transition flex items-center gap-2 shadow-xs cursor-pointer"
            >
          ...
          <div className="bg-white rounded-xl p-3 border border-slate-200/80 shadow-xs flex items-center justify-between gap-4">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full bg-slate-50 text-xs text-slate-800 pr-9 pl-4 py-2 rounded-lg border border-slate-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-theme-primary/20 font-medium"
              />
            </div>
            <button
              onClick={fetchMembers}
              className="px-3 py-2 rounded-lg text-xs font-semibold text-slate-600 hover:bg-slate-100 border border-slate-200 flex items-center gap-1.5 transition cursor-pointer"
            >
                    ...
                    {filteredMembers.map((member) => (
                      <tr key={member.id} className="hover:bg-slate-50/60 transition-colors">
                        <td className="py-3.5 px-4">
                          <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-theme-primary-tint text-theme-primary border border-theme-primary/20 flex items-center justify-center font-bold shadow-xs">
                          ...
                          <div className="flex flex-wrap gap-1 max-w-xs">
                            {Array.isArray(member.brand_access) && member.brand_access.includes('ALL') ? (
                              ...
                              member.brand_access.map((b) => (
                                <span
                                  key={b}
                                  className="px-2 py-0.5 rounded bg-theme-primary-tint text-theme-primary text-[10px] font-bold border border-theme-primary/20"
                                >
                                  {b}
                                </span>
                              ))
                        ...
                        <td className="py-3.5 px-4">
                          <span className="px-2.5 py-1 rounded-lg bg-theme-primary-tint text-theme-primary font-bold border border-theme-primary/20 text-xs inline-block">
                        ...
                        <td className="py-3.5 px-4">
                          <div className="flex items-center justify-center gap-1.5">
                            <button
                              ...
                              className="p-1.5 rounded-lg text-slate-600 hover:text-theme-primary hover:bg-theme-primary-tint transition cursor-pointer"
            ...
            <div className="flex flex-wrap items-center gap-3 flex-1">
              ...
              <div className="relative flex-1 min-w-[200px] max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-3 pr-9 py-2 bg-slate-50 rounded-xl border border-slate-200 text-xs font-medium text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary"
                />
                {searchAuditQuery && (
                  <button
              ...
              {/* Action Filter */}
              <div className="flex items-center gap-2">
                <Filter className="w-3.5 h-3.5 text-theme-primary shrink-0" />
                <select
                  ...
                  <tbody className="divide-y divide-slate-100 text-xs">
                    {auditLogs.map((log) => (
                      <tr
                        ...
                        className="hover:bg-theme-primary-subtle transition-colors cursor-pointer group"
                      >
                        ...
                        <td className="py-3.5 px-4">
                          {log.user_name ? (
                            <div>
                              <p className="font-bold text-slate-900 group-hover:text-theme-primary transition-colors">{log.user_name}</p>
                        ...
                        <td className="py-3.5 px-4 text-center">
                          <button
                            ...
                            className="px-2.5 py-1 rounded-lg text-xs font-bold bg-slate-100 hover:bg-theme-primary-tint text-slate-700 hover:text-theme-primary border border-slate-200 transition"
                          >
                            عرض التفاصيل
                          </button>
                        </td>
            ...
            {totalAuditPages > 1 && (
              <div className="p-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-600 bg-slate-50/50">
                <span className="font-medium">
                  عرض الصفحة <span className="font-bold text-theme-primary">{auditPage}</span> من <span className="font-bold text-theme-primary">{totalAuditPages}</span> (إجمالي {totalAuditLogs} سجل)
                </span>
                <div className="flex items-center gap-2">
                  <button
          ...
          <div className="bg-white rounded-2xl max-w-xl w-full p-6 shadow-2xl border border-slate-200 space-y-4 animate-in fade-in zoom-in-95 duration-150" dir="rtl">
            ...
            <div className="space-y-3 text-xs max-h-[70vh] overflow-y-auto">
              ...
              <div className="space-y-1.5">
                ...
                <pre className="p-3 bg-slate-900 text-emerald-400 font-mono text-[11px] rounded-xl overflow-x-auto whitespace-pre-wrap leading-relaxed max-h-60">
            ...
            <form onSubmit={handleSubmitForm} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 text-xs text-slate-900 p-2.5 rounded-xl border border-slate-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary font-medium"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 text-xs text-slate-900 p-2.5 rounded-xl border border-slate-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary font-medium disabled:opacity-60"
                />
              </div>
              ...
              <div className="flex items-center gap-2 pt-2">
                <input
                  ...
                  className="rounded text-theme-primary focus:ring-theme-primary accent-theme-primary w-4 h-4"
                />
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-100">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-theme-primary hover:bg-theme-primary-hover text-white text-xs font-bold transition flex items-center gap-1.5 shadow-xs disabled:opacity-50"
                >
