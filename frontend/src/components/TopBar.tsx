...
import { MessageSquare, CheckCircle, Settings, Layers, Wifi, Share2, X, Send, Check } from 'lucide-react';
import { MOCK_BRANDS } from '../services/api';
import { useCrmStore, ChannelFilterType } from '../store/useCrmStore';

export const TopBar: React.FC = () => {
  const { selectedBrandId, setSelectedBrandId, selectedChannel, setSelectedChannel, setActiveFilterTab } = useCrmStore();
